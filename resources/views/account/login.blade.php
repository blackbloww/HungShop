...
<div class="flex items-center justify-center mt-10" >
  <div class="w-1/3 mx-auto bg-white rounded-lg shadow-lg overflow-hidden">
      <div class="py-8 px-6">
          <div class="text-center font-semibold text-black text-2xl mb-4">
              Đăng nhập
          </div>
          ...
          <form class="mt-8" method="POST" action="{{ route('login') }}">
              ...
              <div class="mx-auto w-full">
                  <div class="py-2">
                      <span class="px-1 text-sm text-gray-600">Tài khoản</span>
                  ...
                  <div class="flex justify-between items-center my-4">
                      ...
                      <a href="#" class="text-gray-500 font-bold hover:text-gray-700">Forgot Password?</a>
                  </div>

                  <button type="submit"
                      class="mt-3 text-lg font-semibold bg-gray-800 w-full text-white rounded-lg px-6 py-3 block shadow-xl hover:bg-black hover:text-white">
                      Đăng nhập
                  </button>
              </div>
          </form>

          <div class="text-gray-500 font-bold my-4 text-center">
              Bạn chưa có tài khoản?
              <a href="{{ route('register') }}"
                  class="text-black border-b-2 border-gray-200 hover:border-gray-400">đăng ký ngay</a>
          </div>
      </div>
  </div>

  <div class="hidden md:block">
      <img src="https://js0fpsb45jobj.vcdn.cloud/storage/upload/media/login/image83-standard-scale-2-00x-gigapixel.png"
          alt="">
  </div>
</div>
